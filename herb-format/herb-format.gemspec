...
require_relative "lib/herb/format/version"

Gem::Specification.new do |spec|
  spec.name = "herb-format"
  spec.version = Herb::Format::VERSION
  spec.authors = ["Claude"]
  spec.email = ["noreply@anthropic.com"]

  spec.summary = "Formatter for ERB templates"
  spec.description = "A formatter for ERB template files providing automatic code formatting"
