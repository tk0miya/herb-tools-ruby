...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Syntax highlighting for ERB templates"
  spec.description = "Provides ANSI syntax highlighting for ERB/HTML source code, " \
                     "including token-level colorization, diagnostic rendering, and theme support"
