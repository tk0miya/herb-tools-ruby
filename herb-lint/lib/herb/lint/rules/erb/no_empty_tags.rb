  ...
  module Lint
    module Rules
      module Erb
        ...
        #
        # Empty ERB tags serve no purpose and may confuse readers or indicate incomplete code.
        # They clutter the template and may have been left behind accidentally after editing.
        #
        # Good:
        #   <%= user.name %>
        #
