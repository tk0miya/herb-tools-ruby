...
# Description:
#   Report parser errors as linting offenses. This rule surfaces syntax errors,
#   malformed HTML, and other parsing issues that prevent the document from being
#   correctly parsed.
#
# Good:
...
#
# NOTE: Unlike other rules, parser/no-errors is NOT implemented as a standard rule class.
...
# standard rule checks. The Linter handles parse failures early in the pipeline,
# before normal rule execution begins.
#
# Processing Flow:
...
#
# Both TypeScript and Ruby implementations use this same architectural approach.
...
# - Test coverage: spec/herb/lint/rules/parser/no_errors_spec.rb
